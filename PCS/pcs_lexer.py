...
def p_receiptexpr_clear(p):
    ...
    '''
    # receipt clear header                              # DONE
    # receipt clear body                                # DONE
    # receipt clear footer                              # DONE
    print((p[1], p[3], p[5]))
    if p[5] == "header":
...
def makeParagraph(input_tuple):
    ...
    if len(input_tuple) == 2:
        ...
        tempStr = str(input_tuple[0])+str(input_tuple[1])+str(input_tuple[2])+str(makeParagraph(input_tuple[3]))
    else:
        print(" * Not defined * ")
    return tempStr
